...
from camera.camera_exeptions import CameraConfigurationError, CameraNotReadyError
...
from camera.camera_exeptions import CameraCaptureError
from core.storage_exeptions import StoragePermissionError, StorageWriteError
